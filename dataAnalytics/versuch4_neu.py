...
with open("Versuche_09112022.json") as data_file:    
...
# -------- Versuch 1 ---------------
fig.suptitle('Analyse des Versuchs "Kubernetes+Boot" (PC 2)',y=0.992 ,fontsize=16)
...
fig.savefig('./img/versuch4_skal+komb_neu.png', dpi=100)
