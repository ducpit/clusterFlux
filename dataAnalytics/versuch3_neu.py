...
datenNeuerPc="Versuche_09112022.json"
startTime = '17:46'
endTime = '18:30'
...
with open(datenNeuerPc) as data_file:    
...
# -------- Versuch 1 ---------------
fig.suptitle('Analyse des Versuchs "Gesamtstart" (PC 2)',y=0.992 ,fontsize=16)
...
versuch1_disk_data.plot(ax=axes[3],y = ['bread_s', 'bwrtn_s', 'bdscd_s'],ylim=[0,6])
...
fig.savefig('./img/versuch3_boot_ges_neu.png', dpi=100)
