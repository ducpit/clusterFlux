...
datenAlterPc="Versuche_07_gesamt.json"
...
with open(datenAlterPc) as data_file:    
...
# -------- Versuch 1 ---------------
fig.suptitle('Analyse des Versuchs "Booten" (PC 1)',y=0.992 ,fontsize=16)
...
fig.savefig('./img/versuch2_boot_alt.png', dpi=100)
